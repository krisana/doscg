...
## API (Back-end)
```
ZF3 Framework(PHP), Express(Node.JS), Golang or Rust
...
** Make sure you have a cache for every function **
...
** Make sure you have a cache or local storage for every function **
```
